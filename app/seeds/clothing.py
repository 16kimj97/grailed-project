...
def seed_clothing():
    clothing_items = [
        Clothing(user_id=1, title="Supreme Jacket", description="Ideal for spring and fall seasons.", price=75.00, size="M", brand="Supreme", condition="New", images="https://i.postimg.cc/wxXCFXQk/supreme.jpg", date_listed=datetime.utcnow(), status="Available", gender="Menswear"),
        Clothing(user_id=2, title="Chrome Hearts Jeans", description="High-quality vintage denim.", price=45.00, size="L", brand="Chrome Hearts", condition="Used", images="https://i.postimg.cc/2S6gzPRH/Chrome-hearts-jeans.jpg", date_listed=datetime.utcnow(), status="Available", gender="Menswear"),
        ...
        Clothing(user_id=2, title="Off-White Dunks", description="Comfortable walking shoes in white.", price=50.00, size="8", brand="CasualKicks", condition="New", images="https://i.postimg.cc/V6RF0kXX/images.jpg", date_listed=datetime.utcnow(), status="Available", gender="Menswear"),
